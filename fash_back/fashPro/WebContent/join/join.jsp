			...
			<div class="join">
				...
				<div class="info-form">
					<table>
						<tr>
							<td>이름</td>
							<td class="join-input"><input type="text" name="name"
								id="name"></td>
						...
						<tr>
							<td>비밀번호</td>
							<td class="join-input"><input type="password" name="pwd"
								id="pwd"></td>

						</tr>
						<tr>
							<td>비밀번호 재확인</td>
							<td class="join-input"><input type="password" name="pwdCk"
								id="pwdCk"></td>
						</tr>
						<tr>
							<td>이메일</td>
							<td class="join-input-email"><input type="email"
								name="email" id="email"></td>
						</tr>
						<tr>
							<td>성별</td>
							<td class="join-input-gender"><select name="gender"
								id="gender">
						...
						<tr>
							<td>휴대전화</td>
							<td class="join-input"><input type="tel" name="tel" id="tel"
					...
					<div class="submit">
						<a href="#"><button class="join-submit">가입하기</button></a> <br>
						<br> 이미 계정이 있으신가요? -> <a href="../login/login.html"
							class="login">로그인</a>
					</div>
				</div>
			</div>
